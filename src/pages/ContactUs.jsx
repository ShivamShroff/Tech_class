        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <h1 className="text-lg font-semibold text-richblack-5">Chat with me</h1>
                    </div>
                    <p className='font-medium'>I am am here to help.</p>
                    <p className='font-semibold'>shivamshroff111@gmail.com</p>
                </div>
                {/* <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    ...
                    <h1 className="text-lg font-semibold text-richblack-5">make a call</h1>
                </div>
                <p className='font-medium'>Mon - Fri From 8am to 5pm</p>
                <p className='font-semibold'>+91 9798758921</p>
                </div>
            </div>
        </div>
